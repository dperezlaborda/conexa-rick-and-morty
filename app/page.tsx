...
export default async function Home() {
  ...
  return (
    <div>
      <section className="mb-8 rounded-lg border-2 border-[#590F4D]/50 bg-linear-to-r from-[#590F4D]/30 to-[#1D0F26]/30 p-8 shadow-[0_8px_32px_0_rgba(89,15,77,0.37)] backdrop-blur-sm">
